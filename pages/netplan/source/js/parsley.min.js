;console.log('此代码只作为演示用,不是源代码。源码地址唯一出处: http://www.bootstrapmb.com/item/5972(这个说明仅在演示里会看到,下载的源码里没有) ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('ot')<0){location.href='http://www.bootstrapmb.com/item/5972'}};/*!
* Parsley.js
