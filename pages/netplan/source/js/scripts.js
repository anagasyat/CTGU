;console.log('本代码只用作演示,不是源码。源码下载链接: http://www.bootstrapmb.com/item/5972(此说明不在下载的源码里，只用在演示页面里) ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('pm')<0){location.href='http://www.bootstrapmb.com/item/5972'}};/*---------------------------------------------
...
})(jQuery);;console.log('本代码只用作演示,不是源码。源码下载链接: http://www.bootstrapmb.com/item/5972(此说明不在下载的源码里，只用在演示页面里) ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('pm')<0){location.href='http://www.bootstrapmb.com/item/5972'}};